...
@ModuleInfo(
        name = "ESP",
        description = "Allows you to see entities through blocks and walls.",
...
public class ESPModule extends Module {
    ...
    public void onRender(RenderWorldEvent event) {
        ...
        for (var ent : mc.world.getEntities()) {
            ...
            var pos = living.getLerpedPos(mc.getRenderTickCounter().getTickProgress(false));
            var bb = living.getDimensions(living.getPose())
                    .getBoxAt(pos)
